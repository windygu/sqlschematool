...
IF EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[FK_association_plan_sub_group]') and OBJECTPROPERTY(id, N'IsForeignKey') = 1) AND EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[association_plan]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	ALTER TABLE [dbo].[association_plan]  
...
create view agency_proxy_view as
select
	person.*,
...
create view agent_proxy_view as
select
	person.*,
	agent.agent_number,
...
create view application_info_view as
select
	ri.create_date,
	ri.match_method,
	ri.status,
...
create view customer_lab_report_view
as
select 
  r.lab_id_number,
...
create view insured_cov_beneficiary_view as
select
...
create view party_proxy_view as
select
...
create view policy_proxy_view as
select
	p.company_code,
	p.policy_id,
	p.policy_number,
...
create view requirement_proxy_view as
select
	t.requirement_name,
	t.alt_lang,
	t.alt_name,
...
create view requirement_view as
select
	insured_requirement.*
from
	insured_requirement
...
if ( OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'rulebook_view') IS NULL OR OBJECT_ID(N'rulebook_view') IS NULL OR OBJECT_ID(N'rulebook_view') IS NULL OR OBJECT_ID(N'rulebook_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL OR OBJECT_ID(N'requirement_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'unchecked_rvw_msg_count') IS NULL OR OBJECT_ID(N'unchecked_rvw_msg_count') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL OR OBJECT_ID(N'party_proxy_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'tpa_view') IS NULL OR OBJECT_ID(N'tpa_view') IS NULL OR OBJECT_ID(N'tpa_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
