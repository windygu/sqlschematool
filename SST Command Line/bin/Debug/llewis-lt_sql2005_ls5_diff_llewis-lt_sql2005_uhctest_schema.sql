...
BEGIN
	...
	ALTER TABLE [dbo].[association_plan]
	DROP COLUMN  [note_collection_id]  [int]  NULL 
	ALTER TABLE [dbo].[association_plan]
	DROP COLUMN  [company_group_code]  [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	ALTER TABLE [dbo].[association_plan]
	DROP COLUMN  [sub_group_code]  [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	ALTER TABLE [dbo].[association_plan]
	DROP COLUMN  [class_group_code]  [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	-- Alter existing table columns 
	ALTER TABLE [dbo].[association_plan]
		ALTER COLUMN  [association_code]  [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL 
	ALTER TABLE [dbo].[association_plan]
...
BEGIN
	...
	DROP COLUMN  [region_code]  [char]  (50)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	ALTER TABLE [dbo].[company]
	DROP COLUMN  [tpa_code]  [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	ALTER TABLE [dbo].[company]
	DROP COLUMN  [carrier_code]  [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	ALTER TABLE [dbo].[company]
	DROP COLUMN  [enhanced_eapp_flag]  [int]  NULL 
	-- Alter existing table columns 
	ALTER TABLE [dbo].[company]
...
BEGIN
	...
	DROP COLUMN  [election_effective_date]  [datetime]  NULL 
	ALTER TABLE [dbo].[coverage_person_insured]
	DROP COLUMN  [auto_approved_date]  [datetime]  NULL 
	-- add new table columns
	ALTER TABLE [dbo].[coverage_person_insured] 
...
-- COUNT OF ALTERED COLUMNS IN TABLE [form_instance]: 16
...
BEGIN
	...
	DROP COLUMN  [assoc_emp]  [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	ALTER TABLE [dbo].[form_instance]
	DROP COLUMN  [owner_first_name]  [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	ALTER TABLE [dbo].[form_instance]
	DROP COLUMN  [owner_last_name]  [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	-- add new table columns
	ALTER TABLE [dbo].[form_instance] 
...
BEGIN
	...
	-- drop existing table columns that don't exist in new schema
	ALTER TABLE [dbo].[insured_requirement]
	DROP COLUMN  [internal_only]  [int]  NULL 
	-- add new table columns
	ALTER TABLE [dbo].[insured_requirement] 
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	(   
		...
		[fist_name] [varchar] (255)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
-- COUNT OF ALTERED COLUMNS IN TABLE [policy]: 57
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[policy]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	
	-- drop existing table columns that don't exist in new schema
	ALTER TABLE [dbo].[policy]
	DROP COLUMN  [is_holding_until_app_recv]  [int]  NULL 
	-- add new table columns
	ALTER TABLE [dbo].[policy] 
	ADD  [tia_indicator]  [int]  NULL ,
		 ...
		 [bank_account_name]  [varchar]  (255)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL ,
...
BEGIN
	...
	-- drop existing table columns that don't exist in new schema
	ALTER TABLE [dbo].[policy_coverage]
	DROP COLUMN  [total_amount]  [numeric]  NULL 
	-- Alter existing table columns 
	ALTER TABLE [dbo].[policy_coverage]
