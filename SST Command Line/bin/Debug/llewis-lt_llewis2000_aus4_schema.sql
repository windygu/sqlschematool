...
-- DB Name: AUS4
-- Output Date: 8/6/2007
-- Output Time: 10:54 PM
...
IF EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[FK_gnumbers_notes_association_plan]') and OBJECTPROPERTY(id, N'IsForeignKey') = 1) AND EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[crm_notes_xref]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[alt_billing_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[tpa_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		[carrier_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
IF EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[FK_gnumbers_notes_group_notes]') and OBJECTPROPERTY(id, N'IsForeignKey') = 1) AND EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[crm_notes_xref]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	ALTER TABLE [dbo].[crm_notes_xref]  
...
GO
	...
	ALTER COLUMN [plan_code_id] [char]  (10) NOT NULL
	ALTER TABLE [dbo].[crm_notes_xref]
	ALTER COLUMN [gnumber] [char]  (20) NOT NULL
	ALTER TABLE [dbo].[crm_notes_xref]
	ALTER COLUMN [note_id] [int] NOT NULL
GO
...
IF EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[FK_trust_plan_id]') and OBJECTPROPERTY(id, N'IsForeignKey') = 1) AND EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[tl_trust_plan]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
...
GO
		...
		--2nd pass thru after add/alter table columns to handle those columns having UDDTs or Not Nulls 
	ALTER TABLE [dbo].[tl_trust_plan]
	ALTER COLUMN [trust_plan_id] [int] NOT NULL
	ALTER TABLE [dbo].[tl_trust_plan]
	ALTER COLUMN [trust_code] [char]  (10) NOT NULL
	ALTER TABLE [dbo].[tl_trust_plan]
	ALTER COLUMN [plan_code_id] [char]  (10) NOT NULL
GO
...
if ( OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'policy_proxy_view') IS NULL OR OBJECT_ID(N'unchecked_rvw_msg_count') IS NULL OR OBJECT_ID(N'unchecked_rvw_msg_count') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
