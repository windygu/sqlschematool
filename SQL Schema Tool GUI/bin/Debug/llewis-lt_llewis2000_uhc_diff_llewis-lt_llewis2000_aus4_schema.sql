...
-- DB Name: C:\Documents and Settings\llewis.VPI\My Documents\My Projects\SQL Schema Tool\SQL Schema Tool GUI\bin\Debug\llewis-lt_llewis2000_uhc_diff_llewis-lt_llewis2000_aus4_schema.sql
...
BEGIN
	...
	ALTER TABLE [dbo].[company]
		ALTER COLUMN  [region_code]  [char]  (50)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	ALTER TABLE [dbo].[company]
		ALTER COLUMN  [tpa_code]  [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
	ALTER TABLE [dbo].[company]
		ALTER COLUMN  [carrier_code]  [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
--2nd pass thru after 'Alter' table columns to handle those columns having UDDTs 
	ALTER TABLE [dbo].[company]
...
BEGIN
	...
	ALTER TABLE [dbo].[note_collection]
		ALTER COLUMN  [type_code]  [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL 
