...
GO
	...
	ALTER COLUMN [association_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [association_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[association_plan]
	ALTER COLUMN [plan_code_id] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [privilege_id] [int] NOT NULL
	ALTER TABLE [dbo].[aus_security_privilege]
	ALTER COLUMN [name] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[aus_security_privilege]
	ALTER COLUMN [subsystem_name] [char]  (30)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[person_id] [int]  NULL,
		[login_id] [char] (15)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
...
GO
	...
	ALTER COLUMN [user_id] [int] NOT NULL
	ALTER TABLE [dbo].[aus_user_limits]
	ALTER COLUMN [line_of_business_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [language_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[benefit_period]
	ALTER COLUMN [plan_code_id] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[benefit_period]
	ALTER COLUMN [period_id] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [tpa_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[billing_code]
	ALTER COLUMN [line_of_business_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[billing_code]
	ALTER COLUMN [g_number] [char]  (15)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [company_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[company]
	ALTER COLUMN [person_id] [int] NOT NULL
GO
...
GO
	...
	ALTER COLUMN [company_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[company_mib_entry]
	ALTER COLUMN [entry_type] [char]  (5)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER TABLE [dbo].[coverage_benefits]
	ALTER COLUMN [coverage_status] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[coverage_benefits]
...
GO
	...
	ALTER COLUMN [coverage_person_id] [int] NOT NULL
	ALTER TABLE [dbo].[coverage_person_fund_alloc]
	ALTER COLUMN [fund_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[ppo_id] [int]  NULL,
		[election_effective_date] [datetime]  NULL,
		[auto_approved_date] [datetime]  NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
GO
	...
	ALTER COLUMN [policy_coverage_id] [int] NOT NULL
	ALTER TABLE [dbo].[coverage_subaccounts]
	ALTER COLUMN [subaccount_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER TABLE [dbo].[extended_property]
	ALTER COLUMN [property_name] [varchar]  (255)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [company_code] [char]  (5)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[extract_time]
	ALTER COLUMN [extract_type] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER TABLE [dbo].[family_history]
	ALTER COLUMN [famhist_relationship_code] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [form_code] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[form]
	ALTER COLUMN [company_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO


IF (  (SELECT COLUMNPROPERTY( OBJECT_ID(N'form'), N'form_code', 'AllowsNull')) IS NOT NULL  AND   (SELECT COLUMNPROPERTY( OBJECT_ID(N'form'), N'company_code', 'AllowsNull')) IS NOT NULL   ) and EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[form]') and OBJECTPROPERTY(id, N'IsUserTable') = 1) AND (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
BEGIN
	ALTER TABLE [dbo].[form] ADD 
	CONSTRAINT [PK_form] PRIMARY KEY CLUSTERED 
	(
		[form_code], [company_code]
	)  ON [PRIMARY] 
END
ELSE
	RAISERROR ('Constraint column(s): form_code, company_code do(es) not exist, or Table or File Group does not exist.  Check for other errors.', 16, 1)
GO
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[assoc_emp] [char] (20)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[owner_first_name] [char] (20)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[owner_last_name] [char] (20)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL
...
GO
	...
	ALTER TABLE [dbo].[form_question]
	ALTER COLUMN [question_label] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[form_question]
	ALTER COLUMN [question_text] [varchar]  (255)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [impairment_restriction_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[doctor_state] [char] (5)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
...
GO
	...
	ALTER COLUMN [lab_id_number] [char]  (15)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[lab_comment]
	ALTER COLUMN [requirement_information_id] [int] NOT NULL
	ALTER TABLE [dbo].[lab_comment]
	ALTER COLUMN [remark_id] [char]  (4)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[lab_comment]
...
GO
	...
	ALTER COLUMN [requirement_information_id] [int] NOT NULL
	ALTER TABLE [dbo].[lab_header]
	ALTER COLUMN [lab_type_id] [char]  (15)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[lab_header]
	ALTER COLUMN [last_name] [char]  (25)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[lab_header]
	ALTER COLUMN [first_name] [char]  (25)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [requirement_information_id] [int] NOT NULL
	ALTER TABLE [dbo].[lab_result]
	ALTER COLUMN [horl_code] [char]  (8)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [lifesuite_version] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [file_name] [varchar]  (255)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[ls_file]
	ALTER COLUMN [file_type] [char]  (30)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		[group_number] [char] (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL,
		[user_id] [int]  NOT NULL,
		[first_name] [char] (20)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[last_name] [char] (15)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[birth_date] [datetime]  NULL,
		[hire_date] [datetime]  NULL,
		[ssn] [char] (30)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[annual_bae] [numeric]  NULL,
		[app_reason] [char] (50)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[elec_eff_date] [datetime]  NULL,
		[spouse_first_name] [char] (20)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[spouse_last_name] [char] (15)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[spouse_birth_date] [datetime]  NULL,
		[spouse_ssn] [char] (30)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[last_load_date] [datetime]  NULL,
		[status] [char] (30)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
GO
	...
	ALTER COLUMN [group_number] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[member]
	ALTER COLUMN [user_id] [int] NOT NULL
GO


IF (  (SELECT COLUMNPROPERTY( OBJECT_ID(N'member'), N'group_number', 'AllowsNull')) IS NOT NULL  AND   (SELECT COLUMNPROPERTY( OBJECT_ID(N'member'), N'user_id', 'AllowsNull')) IS NOT NULL   ) and EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[member]') and OBJECTPROPERTY(id, N'IsUserTable') = 1) AND (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
BEGIN
...
END
ELSE
	RAISERROR ('Constraint column(s): group_number, user_id do(es) not exist, or Table or File Group does not exist.  Check for other errors.', 16, 1)
GO
		
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[member_product]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	DROP TABLE [dbo].[member_product]
END	
GO

IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	CREATE TABLE [dbo].[member_product]
	( 	
		[group_number] [nchar] (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL,
		[user_id] [int]  NOT NULL,
		[plan_code_id] [nchar] (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL,
		[subgroup_number] [nchar] (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[class_number] [nchar] (10)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
		[amount_eoi] [numeric]  NULL,
		[amount_non_eoi] [numeric]  NULL,
...
GO
		...
		--2nd pass thru after add/alter table columns to handle those columns having UDDTs 
	ALTER TABLE [dbo].[member_product]
	ALTER COLUMN [group_number] [nchar]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[member_product]
	ALTER COLUMN [user_id] [int] NOT NULL
	ALTER TABLE [dbo].[member_product]
	ALTER COLUMN [plan_code_id] [nchar]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO


IF (  (SELECT COLUMNPROPERTY( OBJECT_ID(N'member_product'), N'group_number', 'AllowsNull')) IS NOT NULL  AND   (SELECT COLUMNPROPERTY( OBJECT_ID(N'member_product'), N'user_id', 'AllowsNull')) IS NOT NULL  AND   (SELECT COLUMNPROPERTY( OBJECT_ID(N'member_product'), N'plan_code_id', 'AllowsNull')) IS NOT NULL   ) and EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[member_product]') and OBJECTPROPERTY(id, N'IsUserTable') = 1) AND (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
BEGIN
	ALTER TABLE [dbo].[member_product] ADD 
	CONSTRAINT [PK_member_product] PRIMARY KEY CLUSTERED 
	(
		[group_number], [user_id], [plan_code_id]
	)  ON [PRIMARY] 
END
ELSE
	RAISERROR ('Constraint column(s): group_number, user_id, plan_code_id do(es) not exist, or Table or File Group does not exist.  Check for other errors.', 16, 1)
GO
...
GO
	...
	ALTER COLUMN [requirement_information_id] [int] NOT NULL
	ALTER TABLE [dbo].[mib_header]
	ALTER COLUMN [policy_number] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[mib_header]
	ALTER COLUMN [csy] [varchar]  (3)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[mib_header]
	ALTER COLUMN [last_name] [varchar]  (25)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[mib_header]
	ALTER COLUMN [first_name] [varchar]  (25)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER TABLE [dbo].[object_property]
	ALTER COLUMN [name] [char]  (30)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [occupation] [varchar]  (50)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [person_id] [int] NOT NULL
	ALTER TABLE [dbo].[person_address]
	ALTER COLUMN [address_type_code] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [person_id] [int] NOT NULL
	ALTER TABLE [dbo].[person_phone]
	ALTER COLUMN [phone_type_code] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[is_holding_until_app_recv] [int]  NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
GO
	...
	ALTER COLUMN [provider] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[provider]
	ALTER COLUMN [evidence_type] [char]  (50)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [reinsurance_vendor_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [requirement_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[requirement_match]
	ALTER COLUMN [lab_specimen_id] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [id] [char]  (5)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[sequence_number]
...
GO
	...
	ALTER COLUMN [service_associate_login_id] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[service_associate_range]
	ALTER COLUMN [from_string] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[service_associate_range]
	ALTER COLUMN [to_string] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
		...
		--2nd pass thru after add/alter table columns to handle those columns having UDDTs 
	ALTER TABLE [dbo].[subgroup]
	ALTER COLUMN [sub_group_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[subgroup]
	ALTER COLUMN [company_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[subgroup]
	ALTER COLUMN [person_id] [int] NOT NULL
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		[name] [nvarchar] (128)  COLLATE SQL_Latin1_General_CP1_CI_AI NOT NULL,
...
GO
	...
	ALTER COLUMN [name] [sysname]  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[sysdiagrams]
...
BEGIN
	...
	CONSTRAINT [PK__sysdiagrams__4D35603F] PRIMARY KEY CLUSTERED 
	(
		[diagram_id]
	)  ON [PRIMARY] 
END
...
GO
	...
	ALTER COLUMN [rulebook_id] [int] NOT NULL
	ALTER TABLE [dbo].[ta_point_rule]
	ALTER COLUMN [rule_name] [char]  (50)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [rulebook_id] [int] NOT NULL
	ALTER TABLE [dbo].[te_rulebook]
	ALTER COLUMN [rulebook_name] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [code_type] [char]  (50)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_acord_codes]
	ALTER COLUMN [code_id] [int] NOT NULL
	ALTER TABLE [dbo].[tl_acord_codes]
	ALTER COLUMN [code_value] [char]  (100)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [answer_set_name] [varchar]  (50)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [applicant_status_code] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [beneficiary_type] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [code_type] [char]  (50)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_code]
	ALTER COLUMN [code_id] [char]  (30)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_code]
	ALTER COLUMN [code_value] [varchar]  (1000)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [country_id] [char]  (30)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
		...
		--2nd pass thru after add/alter table columns to handle those columns having UDDTs 
	ALTER TABLE [dbo].[tl_country_state]
	ALTER COLUMN [country_state_id] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_country_state]
	ALTER COLUMN [country_id] [char]  (30)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_country_state]
	ALTER COLUMN [state_code] [char]  (5)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [indicator_code] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [coverage_type] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [death_benefit_option_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [distributor_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_distributor_codes]
	ALTER COLUMN [distributor_description] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [reason_status] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_final_action_reason]
	ALTER COLUMN [reason_text] [varchar]  (100)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [form_type] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [request_code] [varchar]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [lab_specimin_id] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [marital_status_code] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [note_type] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [person_type_id] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [language_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_plan_option]
	ALTER COLUMN [option_type] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_plan_option]
	ALTER COLUMN [plan_code_id] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_plan_option]
	ALTER COLUMN [sequence_number] [int] NOT NULL
...
GO
	...
	ALTER COLUMN [code] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [policy_status_code] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [purpose_of_coverage_id] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [requirement_type_id] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [source_info] [char]  (20)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tl_source_info]
	ALTER COLUMN [source_description] [char]  (30)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [tax_type_id] [char]  (4)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [tobacco_type_id] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [tobacco_use_id] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
GO
...
GO
	...
	ALTER COLUMN [tpa_code] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tpa]
	ALTER COLUMN [tpa_short_name] [char]  (10)  COLLATE SQL_Latin1_General_CP1_CI_AINOT NULL
	ALTER TABLE [dbo].[tpa]
	ALTER COLUMN [person_id] [int] NOT NULL
GO
...
/*Above change was causing error as mentioned in issue #3093
  I have added note_collection_is field again in to field
*/
CREATE VIEW [dbo].[aus_user_view]
AS
SELECT     dbo.person.person_id, dbo.person.party_id, dbo.person.last_name, dbo.person.first_name, dbo.person.middle_name, dbo.person.birth_name, 
                      dbo.person.title, dbo.person.suffix, dbo.person.tax_id, dbo.person.tax_type_id, dbo.person.birth_date, dbo.person.sex, dbo.person.person_type_id, 
                      dbo.person.preferred_language_code, dbo.person.email_address, dbo.person.marital_status, dbo.person.client_id, dbo.person.alt_email_address, 
                      dbo.person.preferred_contact_mode, dbo.person.class_type, dbo.person.field1, dbo.person.field2, dbo.person.field3, dbo.person.field4, 
                      dbo.person.field5, au.user_id, au.login_id, au.password, au.is_active, au.level_of_authority, au.is_underwriter, au.restrict_to_teams, au.role_id, 
                      au.is_service_associate, au.job_title, au.account_locked, au.account_locked_date, au.bad_login_attempt_count, au.last_bad_login_attempt_date, 
                      au.must_change_password, au.last_password_change_date, au.is_agent, au.agent_number, au.is_agency, au.agency_number, au.deleted, 
                      au.use_single_sign_on, dbo.person.note_collection_id
FROM         dbo.person INNER JOIN
                      dbo.aus_user AS au ON dbo.person.person_id = au.person_id
WHERE     (au.deleted IS NULL) OR
                      (au.deleted = 0)
...
union
select 'en-us' as language_code, 'plan_code_description' as code_type, plan_code_id as code_id, description as code_value, alt_description as external_code from tl_plan_code
union
select alt_lang as language_code, 'plan_code_description' as code_type, plan_code_id as code_id, alt_description as code_value, description as external_code from tl_plan_code where alt_lang is not null and alt_lang <> 'en-us'
...
SELECT
	...
	, dbo.company.enhanced_eapp_flag
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[member_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[member_view]
END
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[team_view_eapp]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[team_view_eapp]
END
GO
...
--Created by Sumit Jain on 6/30/2008
--Reason: This view has been created for enhanced e-App
create view team_view_eapp as  
select  
 team.*  
from  
 team  
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[lv_association_gnum_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[lv_association_gnum_view]
END
GO
...
create view [dbo].[lv_association_gnum_view] as
select distinct
	'en-us' as language_code,
	'assn_' + rtrim(ltrim(isnull(ap.company_group_code,''))) + '_' + rtrim(ltrim(isnull(ap.sub_group_code, ''))) + '_' + rtrim(ltrim(isnull(ap.plan_code_id, ''))) as code_type, 
	ap.association_code as code_id,
	p.last_name as code_value,
	tpa.last_name as external_code
from
	association_plan ap,
	company c,
	person p,
...
from
	policy p 
join policy_person pp on pp.policy_id = p.policy_id 
join policy_person_insured ppi on ppi.policy_person_id = pp.policy_person_id
join person i on i.person_id = pp.person_id
join ins_open_post_issue_req_count ir on ir.policy_person_id = pp.policy_person_id
left outer join unchecked_rvw_msg_count rvw on rvw.policy_person_id = pp.policy_person_id
...
if ( OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'tpa_view') IS NULL OR OBJECT_ID(N'tpa_view') IS NULL OR OBJECT_ID(N'tpa_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
