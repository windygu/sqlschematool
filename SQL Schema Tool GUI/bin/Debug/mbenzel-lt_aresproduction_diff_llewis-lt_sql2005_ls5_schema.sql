...
-- Diff Name: Compare results for Source DB XML snapshot: C:\Dev\NYL\mbenzel-lt_AresProduction_SCHEMA.xml,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[marsh_data]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
	if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[FK_balance_id]') and OBJECTPROPERTY(id, N'IsForeignKey') = 1)
BEGIN
	ALTER TABLE [dbo].[marsh_data]  
	DROP CONSTRAINT FK_balance_id
END
GO
	
-- drop new FK Constraints on table, these should not exist, but just to be sure...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[marsh_error]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
	if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[FK_marsh_id]') and OBJECTPROPERTY(id, N'IsForeignKey') = 1)
BEGIN
	ALTER TABLE [dbo].[marsh_error]  
	DROP CONSTRAINT FK_marsh_id
END
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[marsh_balance]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	DROP TABLE [dbo].[marsh_balance]
END
GO
	
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	CREATE TABLE [dbo].[marsh_balance]
	(   
		[balance_id] [int]  NOT NULL,
		[balanced_flag] [int]  NULL,
		[import_pending_flag] [int]  NULL,
		[start_date] [datetime]  NULL,
		[end_date] [datetime]  NULL,
		[process_date] [datetime]  NULL,
		[actual_count] [int]  NULL,
		[marsh_count] [int]  NULL,
		[actual_applied_volume] [numeric]  NULL,
		[marsh_applied_volume] [numeric]  NULL
	)   ON [PRIMARY] 
ELSE
...
IF (  (SELECT COLUMNPROPERTY( OBJECT_ID(N'marsh_balance'), N'balance_id', 'AllowsNull')) IS NOT NULL   ) AND EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[marsh_balance]') and OBJECTPROPERTY(id, N'IsUserTable') = 1) AND (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
BEGIN
	ALTER TABLE [dbo].[marsh_balance] ADD 
...
END
ELSE
	RAISERROR ('Constraint column(s): balance_id do(es) not exist, or Table or File Group does not exist.  Check for other errors.', 16, 1)
GO
		
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[marsh_data]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	DROP TABLE [dbo].[marsh_data]
END
GO
	
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	CREATE TABLE [dbo].[marsh_data]
	(   
		[marsh_id] [int]  NOT NULL,
		[balance_id] [int]  NOT NULL,
		[error_count] [int]  NULL,
		[marsh_record] [varchar] (2207)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
IF (  (SELECT COLUMNPROPERTY( OBJECT_ID(N'marsh_data'), N'marsh_id', 'AllowsNull')) IS NOT NULL   ) AND EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[marsh_data]') and OBJECTPROPERTY(id, N'IsUserTable') = 1) AND (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
BEGIN
	ALTER TABLE [dbo].[marsh_data] ADD 
	CONSTRAINT [PK_marsh_id] PRIMARY KEY CLUSTERED 
	(
		[marsh_id]
	)  ON [PRIMARY] 
END
ELSE
	RAISERROR ('Constraint column(s): marsh_id do(es) not exist, or Table or File Group does not exist.  Check for other errors.', 16, 1)
GO
		
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[marsh_error]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	DROP TABLE [dbo].[marsh_error]
END
GO
	
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	CREATE TABLE [dbo].[marsh_error]
	(   
		[marsh_error_id] [int]  NOT NULL,
		[marsh_id] [int]  NOT NULL,
		[marsh_error_code] [int]  NULL,
		[marsh_error_detail] [varchar] (500)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
IF (  (SELECT COLUMNPROPERTY( OBJECT_ID(N'marsh_error'), N'marsh_error_id', 'AllowsNull')) IS NOT NULL   ) AND EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[marsh_error]') and OBJECTPROPERTY(id, N'IsUserTable') = 1) AND (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
BEGIN
	ALTER TABLE [dbo].[marsh_error] ADD 
	CONSTRAINT [PK_marsh_error_id] PRIMARY KEY CLUSTERED 
	(
		[marsh_error_id]
	)  ON [PRIMARY] 
END
ELSE
	RAISERROR ('Constraint column(s): marsh_error_id do(es) not exist, or Table or File Group does not exist.  Check for other errors.', 16, 1)
GO
...
BEGIN
	...
	DROP COLUMN  [fist_name]  [varchar]  (255)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL 
	-- add new table columns
	ALTER TABLE [dbo].[medical_provider] 
	ADD  [first_name]  [varchar]  (255)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL 
...
BEGIN
	...
	DROP COLUMN  [bank_account_name]  [varchar]  (255)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL 
	ALTER TABLE [dbo].[policy]
	DROP COLUMN  [Credit_Card_Account_Name]  [varchar]  (255)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL 
	-- add new table columns
	ALTER TABLE [dbo].[policy] 
	ADD  [teleunderwriting_indicator]  [int]  NULL 
...
IF (SELECT OBJECT_ID(N'DF__tl_code__languag__6D0D32F4')) IS NULL AND EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[tl_code]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	ALTER TABLE [dbo].[tl_code] ADD 
	CONSTRAINT  [DF__tl_code__languag__6D0D32F4] 
	 DEFAULT ('en-us') FOR language_code
END
ELSE
	PRINT 'Check Constraint DF__tl_code__languag__6D0D32F4 already exist. No need to add.'
GO
...
IF (SELECT OBJECT_ID(N'DF__tpa__tpa_short_n__76619304')) IS NULL AND EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[tpa]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	ALTER TABLE [dbo].[tpa] ADD 
	CONSTRAINT  [DF__tpa__tpa_short_n__76619304] 
	 DEFAULT ('') FOR tpa_short_name
END
ELSE
	PRINT 'Check Constraint DF__tpa__tpa_short_n__76619304 already exist. No need to add.'
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tpa_family_person]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	DROP TABLE [dbo].[tpa_family_person]
END
GO
	
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	CREATE TABLE [dbo].[tpa_family_person]
	(   
		[tpa_family_id] [int]  NOT NULL,
		[current_epsilon_dbkey] [numeric]  NOT NULL,
		[policy_person_id] [int]  NOT NULL,
		[case_group_id] [char] (20)  COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
		[crc32_value] [int]  NULL,
		[requirement_crc32_value] [int]  NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
IF (  (SELECT COLUMNPROPERTY( OBJECT_ID(N'tpa_family_person'), N'tpa_family_id', 'AllowsNull')) IS NOT NULL  AND   (SELECT COLUMNPROPERTY( OBJECT_ID(N'tpa_family_person'), N'current_epsilon_dbkey', 'AllowsNull')) IS NOT NULL   ) AND EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[tpa_family_person]') and OBJECTPROPERTY(id, N'IsUserTable') = 1) AND (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
BEGIN
	ALTER TABLE [dbo].[tpa_family_person] ADD 
	CONSTRAINT [PK_tpa_family_key] PRIMARY KEY CLUSTERED 
	(
		[tpa_family_id], [current_epsilon_dbkey]
	)  ON [PRIMARY] 
END
ELSE
	RAISERROR ('Constraint column(s): tpa_family_id, current_epsilon_dbkey do(es) not exist, or Table or File Group does not exist.  Check for other errors.', 16, 1)
GO
		
-- add new FK Constraints to Table
IF object_id(N'marsh_data') IS NOT NULL AND (SELECT COLUMNPROPERTY( object_id(N'marsh_balance'), N'balance_id', 'AllowsNull') ) IS NOT NULL
BEGIN
	ALTER TABLE [dbo].[marsh_data] ADD 
	CONSTRAINT [FK_balance_id] FOREIGN KEY 
	(	
		[balance_id]
	) REFERENCES [dbo].[marsh_balance] ( 
		[balance_id]
	)
END
ELSE
	RAISERROR ('Constraint referenced table: marsh_data, or the related column: balance_id does not exist', 16, 1)
GO
	
-- add new FK Constraints to Table
IF object_id(N'marsh_error') IS NOT NULL AND (SELECT COLUMNPROPERTY( object_id(N'marsh_data'), N'marsh_id', 'AllowsNull') ) IS NOT NULL
BEGIN
	ALTER TABLE [dbo].[marsh_error] ADD 
	CONSTRAINT [FK_marsh_id] FOREIGN KEY 
	(	
		[marsh_id]
	) REFERENCES [dbo].[marsh_data] ( 
		[marsh_id]
	)
END
ELSE
	RAISERROR ('Constraint referenced table: marsh_error, or the related column: marsh_id does not exist', 16, 1)
GO
	
SET QUOTED_IDENTIFIER, ANSI_NULLS ON 
GO

			ALTER VIEW [agency_proxy_view] as
select
	person.*,
...
GO
			...
			ALTER VIEW [agent_proxy_view] as
select
	person.*,
	agent.agent_number,
...
GO
			...
			ALTER VIEW [application_info_view] as
select
ri.create_date,
ri.match_method,
ri.status,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[association_codes_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[association_codes_view]
END
GO
...
GO
			...
			ALTER VIEW [association_plan_proxy_view] as
select
	ap.association_code,
	ap.plan_code_id,
	tpa_code,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[association_tpa_codes_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[association_tpa_codes_view]
END
GO
...
GO
			...
			ALTER VIEW [automation_event_view] as
select
	*
from
	aus_event
...
GO
			...
			ALTER VIEW [benefit_party_dob_operand_view] as
select
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[caseone_req_event_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[caseone_req_event_view]
END
GO
...
GO
			...
			ALTER VIEW [correspondence_event_view] as
select
	*
from
	aus_event
...
GO
			...
			ALTER VIEW [coverage_benefits_party_view] as
select
	bp.benefit_id ,
...
GO
			...
			ALTER VIEW [coverage_subaccount_view] as
select
...
GO
			...
			ALTER VIEW [customer_lab_report_view]
AS
select 
  r.lab_id_number,
...
GO
			...
			ALTER VIEW [evidence_status_view] as
select
...
GO
			...
			ALTER VIEW [form_question_cmt_operand_view] as
select
...
GO
			...
			ALTER VIEW [form_question_operand_view] as
select
...
GO
			...
			ALTER VIEW [ins_open_post_issue_req_count] as
select
	ir.policy_person_id,
...
GO
			...
			ALTER VIEW [lab_result_operand_view] as
select
...
GO
			...
			ALTER VIEW [lab_result_text_operand_view] as
select
...
GO
			...
			ALTER VIEW [lab_specimen_match_view] as
select
...
GO
			...
			ALTER VIEW [ls_system_search_view] as
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[marsh_data_proxy_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[marsh_data_proxy_view]
END
GO
...
GO
			...
			ALTER VIEW [party_proxy_person_view] as
select
  '' as case_party_id,
  '' as case_id,
  '' as party_type,
...
GO
			...
			ALTER VIEW [party_proxy_view] as
...
GO
			...
			ALTER VIEW [party_relation_view] as
...
GO
			...
			ALTER VIEW [party_requirement_view] as
select
	p.party_id,
	ir.policy_person_id,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[plan_association_codes_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[plan_association_codes_view]
END
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[plan_gnum_assoc_codes_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[plan_gnum_assoc_codes_view]
END
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[plan_gnum_lob_assoc_codes_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[plan_gnum_lob_assoc_codes_view]
END
GO
...
GO
			...
			ALTER VIEW [portal_policy_proxy_view] as
select
	p.policy_id,
	p.policy_number,
	p.policy_status_code,
...
GO
			...
			ALTER VIEW [product_assoc_gnum_lob_view] as
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[product_association_gnum_lob_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[product_association_gnum_lob_view]
END
GO
...
GO
			...
			CREATE view [product_association_gnum_lob_view] as
select distinct 'product_' + rtrim(ap.association_code) + '_' + rtrim(ap.g_number) + '_' + lb.line_of_business_code as code_type, 
	pc.plan_code_id as code_id, 
	rtrim( pc.plan_code_id ) + '-' + pc.description as code_value, 1 as active_flag 
...
GO
			...
			ALTER VIEW [recommended_requirements_view] as
select
...
GO
			...
			ALTER VIEW [req_exists_operand_view] as
select
...
GO
			...
			ALTER VIEW [req_status_operand_view] as
select
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[requirement_exists_operand_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[requirement_exists_operand_view]
END
GO
...
GO
			...
			ALTER VIEW [requirement_group_requirements] as
select
...
GO
			...
			ALTER VIEW [requirement_open_operand_view] as
select
...
GO
			...
			ALTER VIEW [requirement_view] as
select
insured_requirement.*
from
insured_requirement
...
GO
			...
			ALTER VIEW [role_privilege_view] as
select
	arp.role_id,
...
GO
			...
			ALTER VIEW [rulebook_item_view] as
	select
		'' as plan_code_id,
		rb.*
	from
...
GO
			...
			ALTER VIEW [rulebook_rate_class] as
select distinct
...
GO
			...
			ALTER VIEW [service_associate_alpha_range] as
select
  from_string,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sserror_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[sserror_view]
END
GO
...
GO
			...
			ALTER VIEW [teams_users_view] as
select
...
GO
			...
			ALTER VIEW [unchecked_rvw_msg_count] as
select
 rm.policy_person_id,
...
GO
			...
			ALTER VIEW [policy_by_product_proxy_view]
AS
  SELECT p.company_code,
         p.policy_id,
         p.policy_number,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[requirement_order_report_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[requirement_order_report_view]
END
GO

			if ( OBJECT_ID(N'clrLSDecrypt') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL  )
	BEGIN
...
GO
			...
			create view [requirement_order_report_view] as
select
	pol.policy_number,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[requirement_status_report_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[requirement_status_report_view]
END
GO
...
GO
			...
			create view [requirement_status_report_view] as
select
	pol.policy_number,
	pol.case_group_id as family_id,
	ir.insured_requirement_id,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ares_access_rights_lob_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[ares_access_rights_lob_view]
END
GO

			if ( OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ss_upd_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[ss_upd_view]
END
GO

			if ( OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ssintran_error_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[ssintran_error_view]
END
GO

			if ( OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ssinwaiv_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[ssinwaiv_view]
END
GO

			if ( OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ssintran_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
BEGIN
	DROP VIEW [dbo].[ssintran_view]
END
GO

			if ( OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'clrLSDecrypt') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL OR OBJECT_ID(N'marsh_data_proxy_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
GO
			...
			ALTER VIEW [auto_closure_proxy_view] as
select
		*
from
		policy_proxy_view
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_CheckLogon]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_CheckLogon]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_CheckLogon]
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_DeleteCoverage]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_DeleteCoverage]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_DeleteCoverage]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_DEMO]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_DEMO]
END
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetAddress]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetAddress]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetAddress]
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[USP_AUS_GetAgencyInfo]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[USP_AUS_GetAgencyInfo]
END
GO
...
GO
			...
			CREATE PROCEDURE [USP_AUS_GetAgencyInfo]
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetAgencyInfobyPolicyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetAgencyInfobyPolicyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetAgencyInfobyPolicyID]
@policy_id as int
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetAgentbyPolicyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetAgentbyPolicyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetAgentbyPolicyID]
@policy_id as int
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetBeneficiariesbyInsuredID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetBeneficiariesbyInsuredID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetBeneficiariesbyInsuredID]
@insured_id as int
AS
select
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetCompanies]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetCompanies]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetCompanies]
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetCountries]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetCountries]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetCountries]
AS
Select 	country_id,
country_name
From 	tl_country
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetCountryState]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetCountryState]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetCountryState]
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_getEventCount]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_getEventCount]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_getEventCount]
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetFamilyHistorybyInsuredID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetFamilyHistorybyInsuredID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetFamilyHistorybyInsuredID]
@Insured_id as int
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetFamilyRelationships]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetFamilyRelationships]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetFamilyRelationships]
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_Aus_GetInsuredByPersonID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_Aus_GetInsuredByPersonID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_Aus_GetInsuredByPersonID]
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetInsuredInformation]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetInsuredInformation]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetInsuredInformation]
@insured_id as int
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetMIBDetail]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetMIBDetail]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetMIBDetail]
@insuredID int
AS
SELECT
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetMIBHeader]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetMIBHeader]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetMIBHeader]
@insuredID int
AS
SELECT
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetMVRDetailByInsuredID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetMVRDetailByInsuredID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetMVRDetailByInsuredID]
@insuredID int
AS
SELECT
mvr_detail.data,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetMVRHeaderByInsuredID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetMVRHeaderByInsuredID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetMVRHeaderByInsuredID]
@insuredID int
AS
SELECT
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetNoteByNoteID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetNoteByNoteID]
END
GO
...
GO
			...
			CREATE  PROCEDURE [usp_AUS_GetNoteByNoteID]
@noteID as Integer
AS
SELECT
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetNotesByPolicyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetNotesByPolicyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetNotesByPolicyID]
@policyID int
AS
SELECT
notes.note_id,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetNotesByPolicyIDInsuredID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetNotesByPolicyIDInsuredID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetNotesByPolicyIDInsuredID]
@policyID int,
@insuredID int
AS
SELECT
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetNoteTypes]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetNoteTypes]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetNoteTypes]
AS
Select
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetOwner_PayorbyPolicyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetOwner_PayorbyPolicyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetOwner_PayorbyPolicyID]
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetPersonByPersonID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetPersonByPersonID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetPersonByPersonID]
@PersonID as int
AS
SELECT
title,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetPersons]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetPersons]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetPersons] AS
select top 100 *
from person
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetPhoneNumber]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetPhoneNumber]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetPhoneNumber]
@insured_id as int
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetPolicy_FaceAmountbyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetPolicy_FaceAmountbyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetPolicy_FaceAmountbyID]
@policy_id as varchar(20)
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetPolicyHeaderInfobyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetPolicyHeaderInfobyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetPolicyHeaderInfobyID]
@policy_id as varchar(20)
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetPolicyInfobyPolicyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetPolicyInfobyPolicyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetPolicyInfobyPolicyID]
@policy_id as int
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetPolicyNumByPolicyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetPolicyNumByPolicyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetPolicyNumByPolicyID]
@PolicyID int
AS
Select 	company_code,
policy_number
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetPolicyNumInsured]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetPolicyNumInsured]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetPolicyNumInsured]
@policy_id as varchar (20)
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetPurposeofCoverage]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetPurposeofCoverage]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetPurposeofCoverage]
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetQuestionsAnswersbyInsuredID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetQuestionsAnswersbyInsuredID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetQuestionsAnswersbyInsuredID]
@insured_id as int
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetRelatedPoliciesbyPolicyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetRelatedPoliciesbyPolicyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetRelatedPoliciesbyPolicyID]
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetReviewMessageByPolicyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetReviewMessageByPolicyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetReviewMessageByPolicyID]
@policyID as Int
AS
SELECT
(SELECT
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetReviewMessageTopicByMessageID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetReviewMessageTopicByMessageID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetReviewMessageTopicByMessageID]
(
@messageID as Int,
@insuredID as Int
)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetRule]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetRule]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetRule]
(
@rule_id integer,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetRulebookPlancodes]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetRulebookPlancodes]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetRulebookPlancodes]
(
@rulebook_id int
)
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetTeams]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetTeams]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetTeams]
AS
Select 	team_id,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetTobaccoType]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetTobaccoType]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetTobaccoType]
AS
Select *
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetUnderwriters]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetUnderwriters]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetUnderwriters]
AS
Select 	aus.user_id,
(Select
Case
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[USP_AUS_GetUnderwritersbyPolicyID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[USP_AUS_GetUnderwritersbyPolicyID]
END
GO
...
GO
			...
			CREATE PROCEDURE [USP_AUS_GetUnderwritersbyPolicyID]
@policy_id as varchar(20)
AS
Select 	aus.user_id,
(Select
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetUserInfo]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetUserInfo]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetUserInfo]
@userid as int
as
Select distinct
person.first_name,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_GetValidRulebook]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_GetValidRulebook]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_GetValidRulebook]
(
@plancodeID nchar(10),
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertAddressType]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertAddressType]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertAddressType]
(
@code nchar(20),
@langCode nChar(10),
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertAUSUser]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertAUSUser]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertAUSUser]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertBand]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertBand]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertBand]
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertBeneficiaryType]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertBeneficiaryType]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertBeneficiaryType]
(
@code nchar(20),
@langCode nChar(10),
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertCoverage]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertCoverage]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertCoverage]
(
@policy_coverage_id int,
@policy_id int,
@plan_code_id char(10),
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertCoveragePerson]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertCoveragePerson]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertCoveragePerson]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertCoverageType]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertCoverageType]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertCoverageType]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertFamHistRelationship]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertFamHistRelationship]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertFamHistRelationship]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertFamilyHistory]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertFamilyHistory]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertFamilyHistory]
(
@reqinfo_id int,
@famhist_id int,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertInsuredRequirement]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertInsuredRequirement]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertInsuredRequirement]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertLanguage]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertLanguage]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertLanguage]    @LangCode nchar(10),   @Description nchar(50),   @exCol nchar(10) AS INSERT INTO tl_language (language_code, description, external_code)  VALUES(@LangCode, @Description, @exCol)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertNote]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertNote]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertNote]
(
@authorID as Integer,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertNoteType]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertNoteType]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertNoteType]
(
@code nchar(20),
@langCode nChar(10),
@description nchar(20)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPerson]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPerson]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPerson]
(
@person_id int,
@last_name char (50),
@first_name char (20),
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPersonAddress]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPersonAddress]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPersonAddress]
@person_id int,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPhoneType]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPhoneType]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPhoneType]
(
@code nchar(20),
@langCode nChar(10),
@description nchar(20)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPlanCodes]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPlanCodes]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPlanCodes]
(
@plancodeID nchar(10),
@lobcode nChar(10),
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPointAllocation]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPointAllocation]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPointAllocation]
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPolicy]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPolicy]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPolicy]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPolicyCoverage]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPolicyCoverage]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPolicyCoverage]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPolicyPerson]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPolicyPerson]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPolicyPerson]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPolicyRole]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPolicyRole]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPolicyRole]
(
@code nchar(20),
@langCode nChar(10),
@description nchar(50)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPolicyStatusCode]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPolicyStatusCode]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPolicyStatusCode]
(
@code nchar(15),
@langCode nChar(10),
@description nchar(50)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertPurposeOfCoverage]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertPurposeOfCoverage]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertPurposeOfCoverage]
(
@code nchar(20),
@langCode nChar(10),
@description nchar(20)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertRequirement]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertRequirement]
END
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertRequirementGroup]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertRequirementGroup]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertRequirementGroup]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertRequirementInformation]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertRequirementInformation]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertRequirementInformation]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertReviewMessage]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertReviewMessage]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertReviewMessage]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertRule]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertRule]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertRule]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertRulebook]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertRulebook]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertRulebook]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertRuleOption]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertRuleOption]
END
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertTeam]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertTeam]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertTeam]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertTobaccoType]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertTobaccoType]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertTobaccoType]
(
@code nchar(20),
@langCode nChar(10),
@description nchar(20)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_InsertTobaccoUse]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_InsertTobaccoUse]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_InsertTobaccoUse]
(
@code nchar(20),
@langCode nChar(10),
@description nchar(20)
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_MyWork_DiaryPastDue]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_MyWork_DiaryPastDue]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_MyWork_DiaryPastDue]
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_MyWork_ReferralInBox]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_MyWork_ReferralInBox]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_MyWork_ReferralInBox]
@underwriterID as varchar(4),
@mydate as  datetime
as
SELECT policy.policy_number as policy_number,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_MyWork_ReferralOutBox]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_MyWork_ReferralOutBox]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_MyWork_ReferralOutBox]
@underwriterID as varchar(4),
@mydate as  datetime
as
SELECT policy.policy_number as policy_number,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_MyWork_Work]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_MyWork_Work]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_MyWork_Work]
@underwriterID  as  varchar(4),
@mydate as datetime
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_MyWorkRequirementsPastDue]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_MyWorkRequirementsPastDue]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_MyWorkRequirementsPastDue]
@underwriterID as varchar(4),
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_Search]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_Search]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_Search]
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_SelectCoverage]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_SelectCoverage]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_SelectCoverage]
AS
SET NOCOUNT ON
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_Set_PolicyInfo]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_Set_PolicyInfo]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_Set_PolicyInfo]
/*
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_UpdateCoverage]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_UpdateCoverage]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_UpdateCoverage]
(
@policy_coverage_id int,
@policy_id int,
@plan_code_id char(10),
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_UpdateNoteByNoteID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_UpdateNoteByNoteID]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_UpdateNoteByNoteID]
@noteID as Integer,
@authorID as Integer,
@diaryDate as DateTime,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_UpdatePersonAddress]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_UpdatePersonAddress]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_UpdatePersonAddress]
@person_id int,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_UpdatePlanCodeRulebook]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_UpdatePlanCodeRulebook]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_UpdatePlanCodeRulebook]
@rulebook_id int,
@effective_date datetime
AS
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_UpdateRequirement]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_UpdateRequirement]
END
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_UpdateReviewMessageNote]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_UpdateReviewMessageNote]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_UpdateReviewMessageNote]
@noteID as Integer,
@rmID as Integer,
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_UpdateRule]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_UpdateRule]
END
GO
...
GO
			...
			CREATE PROCEDURE [usp_AUS_UpdateRule]
(
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_person]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_person]
END
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_AUS_ProcessReviewMessageNote]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE [dbo].[usp_AUS_ProcessReviewMessageNote]
END
GO

			if ( OBJECT_ID(N'usp_AUS_InsertNote') IS NULL OR OBJECT_ID(N'usp_AUS_UpdateReviewMessageNote') IS NULL  )
	BEGIN
...
GO
			...
			CREATE PROCEDURE [usp_AUS_ProcessReviewMessageNote]
(
@authorID as Integer,
@insuredID as Integer,
@noteType as Char(10),
