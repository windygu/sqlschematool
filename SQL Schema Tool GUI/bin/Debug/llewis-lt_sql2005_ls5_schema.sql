...
-- DB Name: LS5
-- Output Date: 9/27/2008
-- Output Time: 10:48 AM
...
GO
		...
		--2nd pass thru after add/alter table columns to handle those columns having UDDTs 
	ALTER TABLE [dbo].[bisok_document]
	ALTER COLUMN [doc_id] [int]  NOT NULL
	ALTER TABLE [dbo].[bisok_document]
...
GO
	...
	ALTER COLUMN [document_name] [varchar]  (255)  COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
GO
...
GO
	...
	ALTER TABLE [dbo].[FileStore]
	ALTER COLUMN [FileName] [varchar]  (900)  COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
	ALTER TABLE [dbo].[FileStore]
...
GO
	...
	ALTER COLUMN [form_data_attachment_id] [int]  NOT NULL
	ALTER TABLE [dbo].[form_data_attachment]
	ALTER COLUMN [requirement_information_id] [int]  NOT NULL
GO
...
IF EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[FK_frm_data_attch]') and OBJECTPROPERTY(id, N'IsForeignKey') = 1) AND EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[form_data_attachment]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	ALTER TABLE [dbo].[form_data_attachment]  
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[tax_id_no] [varchar] (50)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		[added_date] [datetime]  NULL,
		[added_by] [int]  NULL,
		[update_date] [datetime]  NULL,
		[updated_by] [int]  NULL,
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[drivers_license_number] [varchar] (50)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[attached_document_id] [varchar] (255)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
GO
		...
		--2nd pass thru after add/alter table columns to handle those columns having UDDTs 
	ALTER TABLE [dbo].[lpes_sequence_number]
...
GO
	...
	ALTER COLUMN [client_id] [varchar]  (255)  COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
GO
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[birth_date] [varchar] (50)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		[soc_sec_no] [varchar] (50)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
IF EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[FK_cov_ben_pers_id]') and OBJECTPROPERTY(id, N'IsForeignKey') = 1) AND EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[coverage_benefits_party]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	ALTER TABLE [dbo].[coverage_benefits_party]  
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[address_sequence_id] [char] (10)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[reason_text] [varchar] (100)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		[final_action_note] [varchar] (2000)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		[bank_rounting_number] [varchar] (50)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		...
		[credit_card_number] [varchar] (50)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		[credit_card_expiration_year] [varchar] (50)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		[credit_card_expiration_month] [varchar] (50)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[policy_id] [int]  NOT NULL,
		[log_text] [varchar] (255)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		[user_id] [int]  NULL,
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[sub_role_id] [char] (20)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		[reason_status] [char] (20)  COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
IF (SELECT FILEGROUP_ID('PRIMARY')) IS NOT NULL
	...
	( 	
		...
		[code_prefix] [char] (5)  COLLATE SQL_Latin1_General_CP1_CI_AS NULL
	)   ON [PRIMARY] 
ELSE
	RAISERROR ('You will have to manually add the filegroup PRIMARY to the SQL DB or edit this SQL script to set the FileGroups to PRIMARY', 16, 1)
RETURN
...
create view [dbo].[agent_policy_proxy_view] as
select
	pa.agent_number,
	p.policy_id,
	p.team_id,
...
create view [dbo].[association_plan_proxy_view] as
select
	ap.association_code,
	ap.plan_code_id,
	tpa_code,
...
create view [dbo].[aus_user_view] as
select
	person.*,
	au.user_id,
	au.login_id,
...
create view [dbo].[auto_closure_proxy_view] as
select
		*
from
		policy_proxy_view
...
create view [dbo].[automation_event_view] as
select
	*
from
	aus_event
...
create view [dbo].[benefit_party_dob_operand_view] as   
  select   
...
create view [dbo].[case_event_view] as
select
	*
from
	aus_event
...
create view [dbo].[correspondence_event_view] as
select
	*
from
	aus_event
...
create view [dbo].[coverage_benefits_party_view] as
select
	bp.benefit_id ,
...
create view [dbo].[coverage_subaccount_view] as
select
...
create view [dbo].[data_mart_address] as
select distinct
p.person_id,
...
create view [dbo].[data_mart_case_log] as
select
...
create view [dbo].[data_mart_evidence] as
select
...
create view [dbo].[data_mart_impairment] as
select
...
create view [dbo].[data_mart_phone] as
select distinct
p.person_id,
...
create view [dbo].[diary_activity_proxy_view] as
select
	n.author as user_id,
...
create view [dbo].[evidence_status_view] as
select
...
create view [dbo].[form_data_proxy_view] as
select
...
create view [dbo].[form_data_view] as
select
	fi.*,
	ri.create_date,
	ri.match_method,
...
create view [dbo].[form_question_cmt_operand_view] as
select
...
create view [dbo].[form_question_operand_view] as
select
...
create view [dbo].[form_question_proxy_view] as
select
...
create view [dbo].[insured_coverages_view] as
select
...
create view [dbo].[lab_proxy_view] as
select
	ev.requirement_information_id,
	ev.create_date,
	ev.expiration_date,
...
create view [dbo].[lab_result_operand_view] as
select
...
create view [dbo].[lab_result_text_operand_view] as
select
...
create view [dbo].[lab_specimen_match_view] as
select
...
create view [dbo].[log_event_view] as
select
	*
from
	aus_event
...
create view [dbo].[ls_system_search_view] as
...
create view [dbo].[mib_proxy_view] as
select
	mib.*,
	ev.expiration_date,
	ev.create_date,
...
create view [dbo].[mvr_proxy_view] as
select
	mvr.*,
	ev.expiration_date,
	ev.create_date,
...
create view [dbo].[paramed_view] as
select
	p.*,
	ri.create_date,
	ri.match_method,
...
create view [dbo].[party_proxy_person_view] as
select
  '' as case_party_id,
  '' as case_id,
  '' as party_type,
...
create view [dbo].[party_relation_view] as
...
create view [dbo].[party_requirement_view] as
select
	p.party_id,
	ir.policy_person_id,
...
Create view [dbo].[portal_policy_proxy_view] as
   select
	p.policy_id,
	p.policy_number,
	p.policy_status_code,
...
CREATE view [dbo].[product_assoc_gnum_lob_view] as
...
create view [dbo].[recent_cases_proxy_view] as
select
	p.company_code,
	p.policy_id,
	p.policy_number,
...
create view [dbo].[recommended_requirements_view] as
select
...
create view [dbo].[referral_proxy_view] as
select
	n.note_id,
	n.diary_date,
	p.policy_id,
...
create view [dbo].[requirement_group_requirements] as
select
...
create view [dbo].[requirement_open_operand_view] as
select
...
create view [dbo].[requirement_view] as
select
insured_requirement.*
from
insured_requirement
...
create view [dbo].[review_message_proxy_view] as
select
	p.policy_id,
	p.policy_number,
...
create view [dbo].[role_privilege_view] as
select
	arp.role_id,
...
create view [dbo].[rulebook_item_view] as
	select
		'' as plan_code_id,
		rb.*
	from
...
create view [dbo].[rulebook_proxy_view] as
	select
		rb.association_code,
		rb.effective_date,
		rb.rulebook_id,
...
create view [dbo].[rulebook_rate_class] as
select distinct
...
create view [dbo].[rulebook_view] as
	select
		pc.plan_code_id,
		rb.*
	from
...
create view [dbo].[service_associate_alpha_range] as
select
  from_string,
...
create view [dbo].[teams_users_view] as
select
...
create view [dbo].[user_teams_view] as
select
...
create view [dbo].[data_mart_association_plan] as
select
...
if ( OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
create view [dbo].[reviewer_proxy_view] as
select
	p.company_code,
	p.policy_id,
	p.policy_number,
...
if ( OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
if ( OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
create view [dbo].[tpa_codes_view] as
...
if ( OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
create view [dbo].[data_mart_team] as
select
utv.user_id,
(select
...
if ( OBJECT_ID(N'evidence_status_view') IS NULL OR OBJECT_ID(N'evidence_status_view') IS NULL OR OBJECT_ID(N'evidence_status_view') IS NULL OR OBJECT_ID(N'evidence_status_view') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
create view [dbo].[data_mart_privilege] as
select
role_id,
restriction_level,
privilege_id,
...
if ( OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'aus_user_view') IS NULL OR OBJECT_ID(N'rulebook_view') IS NULL OR OBJECT_ID(N'rulebook_view') IS NULL OR OBJECT_ID(N'rulebook_view') IS NULL OR OBJECT_ID(N'rulebook_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
create view [dbo].[data_mart_requirement] as
select
...
if ( OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL OR OBJECT_ID(N'requirement_proxy_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
create view [dbo].[data_mart_tpa] as
select
tv.person_id,
tv.party_id,
...
create view [dbo].[data_mart_company] as
select
cv.company_code,
...
if ( OBJECT_ID(N'company_view') IS NULL OR OBJECT_ID(N'company_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
create view [dbo].[data_mart_coverage] as
select
...
create view [dbo].[data_mart_user] as
select
uv.person_id,
uv.party_id,
...
create view [dbo].[data_mart_party] as
select
ppv.case_party_id,
ppv.case_id,
ppv.party_type,
...
if ( OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agency_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'agent_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'application_info_view') IS NULL OR OBJECT_ID(N'company_view') IS NULL OR OBJECT_ID(N'company_view') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_address') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'data_mart_phone') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'insured_coverages_view') IS NULL OR OBJECT_ID(N'tpa_view') IS NULL OR OBJECT_ID(N'tpa_view') IS NULL OR OBJECT_ID(N'tpa_view') IS NULL  )
	BEGIN
		RAISERROR ('Required view object dependency is missing, unable to create view', 16, 1)
	END
...
create view [dbo].[data_mart_applicant] as
select
