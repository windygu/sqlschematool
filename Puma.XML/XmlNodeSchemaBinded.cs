	...
	public class XmlNodeSchemaBinded
	{
		...
		public virtual Type SystemType
		{
			get
			{
				...
				XmlSchemaDatatype xmlSchemaDatatype = ( simpleType != null ) ? simpleType.Datatype : _xmlSchemaElement.ElementType as XmlSchemaDatatype;
		...
		public virtual object GetRestriction(XmlNodeSchemaBindedRestrictionsType XmlNodeSchemaBindedRestriction)
		{
			...
			#endregion
			XmlSchemaSimpleType xmlSchemaSimpleType = _xmlSchemaElement.ElementType as XmlSchemaSimpleType;
